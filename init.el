...
(defvar lbo:git-grep-template
  "git --no-pager grep -I --recurse-submodules --ignore-case -n -e <R> -- <F>")

(defun lbo:git-grep (regexp)
  (interactive (progn
                 (grep-compute-defaults)
                 (list (grep-read-regexp))))
  (let ((vc-git-grep-template lbo:git-grep-template))
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("d6603a129c32b716b3d3541fc0b6bfe83d0e07f1954ee64517aa62c9405a3441"
     ...
     "75cd4234cc08d4ccf3ddef8fb763b9e145d4e68d3c938a3502d892c72f71e007"
 ...
 '(safe-local-variable-values
   '((indent-tabs) (org-src-fontify-natively . t)
     (c-style . "stroustrup") (org-clock-continuously . t)
     (eval font-lock-add-keywords nil
           '(("(\\(dvar\\|maximize\\|minimize\\|s.t.\\|for\\|where\\|sum\\) "
              1 font-lock-keyword-face)))
     (c-style . "K&R") (intent-tabs-mode) (c-style . K&R)
     (encoding . latin-1-dos) (org-clock-into-drawer)))
